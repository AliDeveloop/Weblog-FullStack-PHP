jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        showfacebook:true,
        titlecss:"display:table; position:relative; font:18px \"b yekan\",\"Lucida Grande\",sans-serif,Arial; color:#fff; white-space:nowrap; background-color:#e04000; padding:10px;",
        ribbonimagey:0,
        ribbonimagex:0,
